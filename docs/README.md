...
2. Crie uma nova **branch** e nomeie como 'feat/community/seunomedeusuario': 'git checkout -b feat/community/seunomedeusuario';
    > Exemplos 'git checkout -b feat/community/elianaandrade'
